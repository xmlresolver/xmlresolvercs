...
namespace UnitTests {
    public class CMNextTest : BaseTestRoot {
        ...
        public void Setup() {
            ...
            config.AddCatalog(UriUtils.Resolve(TEST_ROOT_DIRECTORY, "UnitTests/resources/cm/nextroot.xml").ToString());
            config.AddCatalog(UriUtils.Resolve(TEST_ROOT_DIRECTORY, "UnitTests/resources/cm/following.xml").ToString());
