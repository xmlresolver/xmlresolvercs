...
public abstract class ResolverFeature {
    private static readonly Dictionary<string,ResolverFeature> _index = new ();
    ...
    public static readonly StringResolverFeature ACCESS_EXTERNAL_DOCUMENT = register(new StringResolverFeature(
        "http://xmlresolver.org/feature/access-external-document", "all"));

    public static readonly StringResolverFeature ACCESS_EXTERNAL_ENTITY = register(new StringResolverFeature(
